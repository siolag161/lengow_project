...
Afterwards please reference the actual `README.md` you just created in your new project folder, all the references to "lengow" will be changed accordingly.
...
*Prerequisites: virtualenv, virtualenvwrapper*
    ...
    cd lengow
    mkvirtualenv lengow-dev && add2virtualenv `pwd`
    mkvirtualenv lengow-prod && add2virtualenv `pwd`
    mkvirtualenv lengow-test && add2virtualenv `pwd`
